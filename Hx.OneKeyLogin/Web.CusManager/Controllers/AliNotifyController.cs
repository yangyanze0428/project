...
{
    public class AliNotifyController : ControllerBase
    {
        ...
        public AliNotifyController(IRechargeService rechargeService, IBalanceService balanceService, RedisHelper redisHelper, ICustomerService customerService, IProdService prodService, AlipayService alipayService, IConfiguration configuration)
        {
