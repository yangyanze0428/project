...
(function(factory){
  ...
  var Datetimepicker = function (element, options) {
    ...
    this.defaultTimeZone = 'GMT ' + (new Date()).getTimezoneOffset() / 60;//何聪修改于2017.1.4
    //this.defaultTimeZone = (new Date).toString().split('(')[1].slice(0, -1);//何聪修改于2017.1.4
